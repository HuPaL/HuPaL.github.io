...
$(function(){$(".spoiler-title").click(function(){return $(this).parent().children(".spoiler-body").slideToggle(),!1}),$(".spoiler-title").click(function(){return $(".forex-bg").css("background-image","url(../img/fx1.png)"),$(".forex-bg2").css("background-image","url(../img/fx2.png)"),!1}),$(".tab a").on("click",function(e){e.preventDefault(),$(this).parent().addClass("active"),$(this).parent().siblings().removeClass("active"),target=$(this).attr("href"),$(".tab-content > div").not(target).hide(),$(target).fadeIn(600)}),$(".go_to").click(function(){var e=$(this).attr("href");return 0!=$(e).length&&$("html, body").animate({scrollTop:$(e).offset().top},1e3),!1}),$(window).on("load",function(){$(".wrapper").delay(1e3).fadeOut("slow")});var e=new TimelineMax({repeat:-1});e.add(TweenMax.from(".logo-svg",2,{scale:.5,rotation:360,ease:Elastic.easeInOut})),e.add(TweenMax.to(".logo-svg",2,{scale:.5,rotation:360,ease:Elastic.easeInOut}))});