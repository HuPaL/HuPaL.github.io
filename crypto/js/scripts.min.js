...
$(function(){$(window).scroll(function(){$(window).scrollTop()>400?$(".top-line").addClass("top-menu-fixed"):$(".top-line").removeClass("top-menu-fixed")});var e=document.getElementById("nav-trigger"),a=document.getElementById("nav");document.getElementById("header"),document.getElementById("heading"),document.getElementsByClassName("nav-label"),window.innerHeight,window.innerWidth;e.addEventListener("click",function(t){e.className.indexOf("close")>0?(e.className="nav-trigger open",a.className="out"):(e.className="nav-trigger close",a.className="in")}),$(".slide-one").owlCarousel({items:1,loop:!0,margin:10,nav:!0,navText:['<i class="fa fa-long-arrow-left" aria-hidden="true"></i> PREVIOUS /','NEXT<i class="fa fa-long-arrow-right" aria-hidden="true"></i>'],autoplay:!0,autoplayTimeout:3e3,smartSpeed:1e3}),$(".slide-two").owlCarousel({items:1,loop:!0,margin:10,nav:!1,autoplay:!0,autoplayTimeout:3e3,autoplayHoverPause:!0}),$(".slide-three").owlCarousel({items:1,loop:!0,margin:10,nav:!1,autoplay:!0,autoplayTimeout:3e3,smartSpeed:1e3}),$(".risk").waypoint(function(){$(".risk-text-wrap").addClass("fadeInLeft"),$(".risk-image-wrap").addClass("fadeInRight")},{offset:"50%"}),$(".graph").waypoint(function(){$(".graph-item").addClass("fadeInLeft"),$(".risk-text-graph").addClass("fadeInRight")},{offset:"50%"}),$(".services").waypoint(function(){$(".services-title").addClass("fadeInLeft"),$(".services-item").addClass("fadeInDown")},{offset:"50%"}),$(".main-video").waypoint(function(){$(".main-video-wrap").addClass("fadeInLeft"),$(".main-video-text").addClass("fadeInRight")},{offset:"50%"}),$(".main-contact").waypoint(function(){$(".main-contact-title").addClass("fadeInLeft"),$(".main-contact-icon").addClass("fadeInRight")},{offset:"50%"}),$(".achievement").waypoint(function(){$({blurRadius:5}).animate({blurRadius:0},{duration:1200,easing:"swing",step:function(){$(".achievement .achievement-item p").css({"-webkit-filter":"blur("+this.blurRadius+"px)",filter:"blur("+this.blurRadius+"px)"})}});var e=$.animateNumber.numberStepFactories.separator(" ");$(".achievement .achievement-item p").each(function(){var a=$(this).data("count");$(this).animateNumber({number:a,easing:"easeInQuad","font-size":"2.5em",numberStep:e},1200)}),this.destroy()},{offset:"30%"}),$(".modal").each(function(){$(this).wrap('<div class="overlay"></div>')}),$(".open-modal").on("click",function(e){e.preventDefault(),e.stopImmediatePropagation;var a=$(this),t=$(a).data("modal");$(t).parents(".overlay").addClass("open"),setTimeout(function(){$(t).addClass("open")},350),$(document).on("click",function(e){var a=$(e.target);$(a).hasClass("overlay")&&($(a).find(".modal").each(function(){$(this).removeClass("open")}),setTimeout(function(){$(a).removeClass("open")},350))})}),$(".close-modal").on("click",function(e){e.preventDefault(),e.stopImmediatePropagation;var a=$(this),t=$(a).data("modal");$(t).removeClass("open"),setTimeout(function(){$(t).parents(".overlay").removeClass("open")},350)})}),$(".form").find("input, textarea").on("keyup blur focus",function(e){var a=$(this),t=a.prev("label");"keyup"===e.type?""===a.val()?t.removeClass("active highlight"):t.addClass("active highlight"):"blur"===e.type?""===a.val()?t.removeClass("active highlight"):t.removeClass("highlight"):"focus"===e.type&&(""===a.val()?t.removeClass("highlight"):""!==a.val()&&t.addClass("highlight"))}),$(".tab a").on("click",function(e){e.preventDefault(),$(this).parent().addClass("active"),$(this).parent().siblings().removeClass("active"),target=$(this).attr("href"),$(".tab-content > div").not(target).hide(),$(target).fadeIn(600)}),$("#country").countrySelect(),$(".gallery-link").magnificPopup({type:"image",closeOnContentClick:!0,closeBtnInside:!1,mainClass:"mfp-with-zoom mfp-img-mobile",image:{verticalFit:!0,titleSrc:function(e){return e.el.find("figcaption").text()||e.el.attr("title")}},zoom:{enabled:!0},gallery:{enabled:!0,navigateByImgClick:!1,tCounter:""},disableOn:function(){return!($(window).width()<640)}}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});